...
// @author      Redstone & SPGoding & SPX Fellow
...
// @require     https://fastly.jsdelivr.net/gh/sizzlemctwizzle/GM_config@master/gm_config.js
// @version     3.0.0
    ...
    function getHeader(articleType, type) {
      ...
      switch (type) {
        case VersionType.Snapshot:
            ...
            return `[indent]
[color=#388e3c][size=5]|[/size][/color][size=4][b]每周快照[/b]是Minecraft Java版的测试机制，主要用于下一个正式版的特性预览。[/size]
[color=#f44336][size=5]|[/size][/color][size=4]然而，[b]每周快照[/b]主要用于新特性展示，通常存在大量漏洞。因此对于普通玩家建议仅做[color=Red][b]测试尝鲜[/b][/color]用。在快照中打开存档前请务必[color=Red][b]进行备份[/b][/color]。[b]适用于正式版的Mod不兼容快照，且大多数Mod都不对每周快照提供支持[/b]。 [/size]
[color=#f44336][size=5]|[/size][/color][size=4]转载本帖时须注明[color=Red]原作者[/color]以及本帖地址。[/size]
[color=#388e3c][size=5]|[/size][/color][size=4]部分新特性译名未最终确定，以下译名仅供参考。[/size]
[hr]\n`;

        case VersionType.PreRelease:
            return `[indent]
[color=#388e3c][size=5]|[/size][/color][size=4][b]预发布版[/b]是Minecraft Java版的测试机制，如果该版本作为正式版发布，那么预发布版的游戏文件将与启动器推送的正式版完全相同。[/size]
[color=#f44336][size=5]|[/size][/color][size=4]然而，预发布版主要用于服主和Mod制作者的预先体验，如果发现重大漏洞，该预发布版会被新的预发布版代替。因此建议普通玩家[color=Red]持观望态度[/color]。 [/size]
[color=#388e3c][size=5]|[/size][/color][size=4]转载本帖时须注明[color=Red]原作者[/color]以及本帖地址。[/size]
[hr]\n`;
...
[hr]
        ...
        case VersionType.Release:
            return `[indent]
[color=#388e3c][size=5]|[/size][/color][size=4][b]Minecraft Java版[/b]是指Windows、Mac OS与Linux平台上，使用Java语言开发的Minecraft版本。[/size]
[color=#f44336][size=5]|[/size][/color][size=4][b]正式版[/b]是Minecraft Java版经过一段时间的预览版测试后得到的稳定版本，也是众多纹理、Mod与服务器插件会逐渐跟进的版本。官方启动器也会第一时间进行推送。 [/size]
[color=#f44336][size=5]|[/size][/color][size=4]建议玩家与服主关注其相关服务端、Mod与插件的更新，迎接新的正式版吧！专注于单人原版游戏的玩家可立即更新，多人游戏玩家请关注您所在服务器的通知。[/size]
[color=#388e3c][size=5]|[/size][/color][size=4]转载本帖时须注明[color=Red]原作者[/color]以及本帖地址。[/size]
[hr]\n`;

        case VersionType.BedrockRelease:
            return `[indent]
[color=#388e3c][size=5]|[/size][/color][size=4][b]Minecraft 基岩版[/b]是指运行在移动平台（Android、iOS）、Windows 10、主机（Xbox One、Switch、PlayStation 4）上，使用「基岩引擎」（C++语言）开发的 Minecraft 版本。[/size]
[color=#f44336][size=5]|[/size][/color][size=4][b]正式版[/b]是Minecraft基岩版经过一段时间的测试版测试之后得到的稳定版本，也是众多纹理、Addon和官方领域服会逐渐跟进的版本。与此同时Google Play、Win10 Store等官方软件商店也会推送此次更新。 [/size]
[color=#388e3c][size=5]|[/size][/color][size=4]转载本帖时须注明原作者以及本帖地址。[/size]
[hr]\n`;

        case VersionType.BedrockBeta:
            return `[indent]
[color=#388e3c][size=5]|[/size][/color][size=4][b]测试版[/b]是Minecraft基岩版的测试机制，主要用于下一个正式版的特性预览。[/size]
...
[color=#388e3c][size=5]|[/size][/color][size=4][b]想了解更多游戏资讯？[/b]
[/size][/list][size=4][size=3][url=https://klpbbs.com/forum-2-1.html]苦力怕论坛 - 游戏资讯版块[/url][/size]
[/size]
[/indent]`;
...
【原帖地址：<原帖地址>】
[color=#388e3c][size=5]|[/size][/color][size=4][b]想了解更多游戏资讯？[/b]
[*][size=3][url=https://klpbbs.com/forum-2-1.html]苦力怕论坛 - 游戏资讯版块[/url][/size]
[/indent]
            `;
